...
export default class Mentor extends React.Component{
    ...
    constructor(props) {
        ...
        this.state = {
                    ...
                    Status : 
                        {
                           currentStatus: "Pursuing PHD in Georgia Tech"
                        },
                    Skills:
                            {
                                skill: "In current job Action script 3.0/Flash, Php, Javascript, MySql, Redis,Node.js, MemcacheIn previous jobs Ruby on Rails, PythonLearnt as Hobby HTML, CSS, Jquery, Jquery Mobile,"
                       ...
                       Projects :[
                           ...
                           id:1,
                           Pname:"Project Name",
                           matter:"This project is about tackling with things using IOT"
