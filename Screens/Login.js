...
{/* ------------------------------------------------facebook login button----------------------------- */}
            ...
            onPress={()=>
              ...
              onFacebookButtonPress().then(() =>setUser(true)
...
{/* ------------------------------------------------Google login button--------------------------------- */}
    ...
    {/* --------------------------------------------with mail and password------------------------------ */}
            ...
            <Text style={{alignSelf:'center',marginTop:30}}>Login with email</Text>
            ...
            onPress={()=>signinwithmailpassword()}>
              {Activityloader()}
            <Text style={{fontSize:16,color:"white",fontWeight:"bold",marginTop:9}}>Log in</Text>
            </TouchableOpacity>
            <View style={{alignContent:"flex-end",marginLeft:150}}>
