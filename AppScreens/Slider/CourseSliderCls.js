...
import { Text, View,TouchableOpacity,Linking ,ScrollView,StyleSheet,TouchableHighlight,Alert,Button} from 'react-native'
...
export default class  CourseSliderCls extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            currentPosition:0,
    ...
    render(){
        ...
        const l = this.props.route.params;
    ...
    // {console.log(route.params,'testing');}
        return (
            ...
            <View style={{flex:1,backgroundColor:"#116FAF",}}>
              ...
              <View style={{ display:'flex',flexDirection:'row'}}>
                  ...
                  <View>
                      ...
                      <TouchableOpacity onPress={()=>this.props.navigation.goBack()} style={{margin:20}}>
                          {/* <Back/> */}
                          <View>
            ...
            //    style={{justifyContent:'center',alignItems:'center'}}
               >
              <Text style={{color:'#FFFFFF',fontSize:20,fontWeight:'bold',margin:20}}>{l.name}</Text>
              </View>
              </View>
              <View 
