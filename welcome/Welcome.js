...
export default class Welcome extends Component {
    render() {
        return (
            <View style={{backgroundColor:'#116faf', width:414,height:896}}>
                ...
                <View style={{backgroundColor:"116faf",height:256,width:416,marginTop:5,justifyContent:"center"}}>
                    <TouchableOpacity style={{width:360,height:63,borderRadius:38,backgroundColor:"#EBEAEC",marginLeft:16,marginTop:10}}>
